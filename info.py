...
BOT_TOKEN = environ.get('BOT_TOKEN', "8302871737:AAF7s6Na08fjLIiv2u9tMM2nu1EtucxqqyY")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://envs.sh/Qa2.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/Qa2.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://envs.sh/Qa2.jpg")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7901412493 865764383').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002543368645 -1002448539135 -1002535480402').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002970592652'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002970592652'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003056919332'))  # Premium logs channel id
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/628a9bfe9b90c1fae6af2-f8a6fa8bb47de31ed5.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'arjunredd@ybl')    # Owner UPI ID for payments
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Malli4U_Database') # Collection name (default: dreamcinezone_files)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002866063350'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003056919332')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003056919332')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/howtosolvelinks/20")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/howtosolvelinks/20")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/howtosolvelinks/20")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "ac18377557e8bfd355da3dc6f408b850ca27753e") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "gplinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "ac18377557e8bfd355da3dc6f408b850ca27753e")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "gplinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "ac18377557e8bfd355da3dc6f408b850ca27753e")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "gplinks.com") # Shortener website for third website

TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "5400")) # Time gap for two-step verification in seconds (default: 20 minutes)
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "5400"))    

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+yYiKU0x6eGw3OGU1') # Group link for the bot
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '865764383 7901412493').split()]
