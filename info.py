...
PICS = (environ.get('PICS', 'https://envs.sh/Ehv.jpg https://envs.sh/Eha.jpg https://envs.sh/Ehm.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6725874739').split()] # Replace with the actual admin ID(s) to add
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002825123866')  # Request channel id (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1001648037641 -1001666034664 -1001652386266 -1002711022996")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/56b5deb73f3b132e2bb73.jpg')    # QR code image for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Priyanshu2023:AnFmGaaucTpXWyiw@cluster0.gpvsndf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Priyanshu105777:03YrLPaBfQQR036I@cluster0.2cnmghz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
