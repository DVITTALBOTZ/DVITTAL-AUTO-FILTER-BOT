...
BOT_TOKEN = environ.get('BOT_TOKEN', "8272515462:AAEdOG-mEBW4yjZuMr11slWlAbAPlsDrFgk")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://envs.sh/v2F.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/v2F.jpg")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5215993250').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003132923661').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003110961210'))  # Log channel id (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003074419298')  # Request channel id (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Ovesh:ovesh.boss@ovesh.95jpp8g.mongodb.net/?retryWrites=true&w=majority&appName=Ovesh")  # MongoDB URI for the database
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Karthik_pro_12') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/MG_movie') # Update channel link for the bot
