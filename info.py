...
LOG_CHANNEL = int(
    environ.get("LOG_CHANNEL", "-100")
)  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(
    environ.get("BIN_CHANNEL", "-100")
...
# ============================
QR_CODE = environ.get(
    "QR_CODE", "https://graph.org/file/e419f801841c2ee3db0fc.jpg"
)  # QR code image for payments
OWNER_UPI_ID = environ.get(
    "OWNER_UPI_ID", "ɴᴏ ᴀᴠᴀɪʟᴀʙʟᴇ ʀɪɢʜᴛ ɴᴏᴡ"
)  # Owner UPI ID for payments
...
MULTIPLE_DB = is_enabled(
    os.environ.get("MULTIPLE_DB", "False"), False
...
LANDSCAPE_POSTER = bool(
    environ.get("LANDSCAPE_POSTER", True)
...
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "a7ac9b3012c67d7491414cf272d82593c75f6cbb"
...
OWNER_LNK = environ.get(
    "OWNER_LNK", "https://t.me/dreamxbotz"
)  # Owner link for the bot
UPDATE_CHNL_LNK = environ.get(
    "UPDATE_CHNL_LNK", "https://t.me/dreamxbotz"
...
NO_RESULTS_MSG = bool(
    environ.get("NO_RESULTS_MSG", True)
...
P_TTI_SHOW_OFF = is_enabled(
    (environ.get("P_TTI_SHOW_OFF", "False")), False
...
SPELL_CHECK_REPLY = is_enabled(
    environ.get("SPELL_CHECK_REPLY", "True"), True
