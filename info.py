...
# ============================
SESSION = environ.get('SESSION', 'dvittalbotz_search')   # Session name for the bot
...
PICS_URL = (environ.get('PICS', 'https://files.catbox.moe/i9xwka.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://files.catbox.moe/e3rta0.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://files.catbox.moe/sg2tnu.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/1vc5g8.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/df0cp9.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '467').split()] # Replace with the actual admin ID(s) to add
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/c38rq1.jpg')    # QR code image for payments
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'dvittalcinezone_files') # Collection name (default: dvittalcinezone_files)
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/DvittalBotz")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/DVITTALBOTZ")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/DvittalBotz")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/DVITTALBOTZ_Disscussion') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'http://t.me/dvittalbotz?direct') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/DVITTALBOTZ') # Update channel link for the bot
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'dvittalbotz'))
MULTI_CLIENT = False
name = str(environ.get('name', 'DVITTALBOTZ'))
