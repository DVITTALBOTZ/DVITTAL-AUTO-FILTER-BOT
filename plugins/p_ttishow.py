...
from database.ia_filterdb import db as db_stats
from database.ia_filterdb import db2 as db2_stats
from database.users_chats_db import db, db2
from info import ADMINS, LOG_CHANNEL, MELCOW_PHOTO, MULTIPLE_DB, OWNER_LNK
        ...
        if not await db.get_chat(message.chat.id):
            ...
            await bot.send_message(
                ...
                script.LOG_TEXT_G.format(
                    message.chat.title, message.chat.id, total, dreamx_botz
                ),
            )
