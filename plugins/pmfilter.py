        ...
        if pm_search:
            ...
            await message.reply_text(
                text=(
                    ...
                    "<blockquote>"
                    "ನೀವು Movie Search ಅನ್ನು ನಮ್ಮ Movie Group ನಲ್ಲಿ ಮಾತ್ರ ಮಾಡಬಹುದು."
                    "ನಿಮಗೆ Direct Bot ನಲ್ಲಿ Movie Search ಮಾಡುವ ಅನುಮತಿ ಇಲ್ಲ. ದಯವಿಟ್ಟು ಕೆಳಗೆ ನೀಡಿರುವ REQUEST HERE ಬಟನ್ ಮೇಲೆ ಕ್ಲಿಕ್ ಮಾಡಿ ನಮ್ಮ Movie Group ಗೆ ಸೇರಿ. ನಂತರ ಅಲ್ಲಿ ನಿಮ್ಮ ಇಷ್ಟದ ಸಿನಿಮಾವನ್ನು ಹುಡುಕಬಹುದು. "
                    "</blockquote></b>"
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('𝗗𝗩𝗜𝗧𝗧𝗔𝗟𝗕𝗢𝗧𝗭📜', url='https://github.com/DVITTALBOTZ/DVITTAL-AUTO-FILTER-BOT.git'),
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
